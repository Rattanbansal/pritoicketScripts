...
Linked_Distributors_LIST="select distinct(cod_id) as cod_id from qr_codes where sub_catalog_id = '$CatalogID' and cod_id not in (13963,14121,14122,14123,14124,14125,14126,14127,14128,14129,14130,14131,14132,14133,14134,14135,14136,14137,14138,14139,14141,14142,14143,14144,14145,14146,14147,14148,14153,14154,14159,14160,14161,14162,14163,14165,14166,35760,35762,35764,35776,36068,36070,14144,36070,36196,38212,38596,39208,39248,39250,40690,41793,45714,46758,48072,48195,49010,49544,50616,50667,51118,51565,51858,53195,53504) and cashier_type = '1'"
