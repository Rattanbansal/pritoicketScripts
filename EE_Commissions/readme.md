...
------ discussion with Rutger

select sub_catalog_id, ticket_id, commission from (select sub_catalog_id, ticket_id, commission from (SELECT d.*, q.cod_id, q.sub_catalog_id FROM distributors d left join qr_codes q on d.hotel_id = q.cod_id where q.cashier_type = '1') as base where sub_catalog_id != '0' group by sub_catalog_id, ticket_id, commission) as base where sub_catalog_id = '171640808526563' and ticket_id = '61440'; 
