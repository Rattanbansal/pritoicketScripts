...
echo "vt_group_no,transaction_id,order_confirm_date,created_date,hotel_id,channel_id,ticketId,ticketpriceschedule_id,version,row_type,partner_gross_price,partner_net_price,order_currency_partner_gross_price,order_currency_partner_net_price,supplier_gross_price,supplier_net_price,col2,company_id,company_pricelist_id,company_sub_catalog,Type,tlc_ticketpriceschedule_id,resale_currency_level,tlc_commissions,type2,catalog_id,sc_ticketpriceschedule_id,sc_resale_currency_level,sucatalog_commissions,type3,clc_ticketpriceschedule_id,pricelist_commissions,should_be" > mismatch.csv
